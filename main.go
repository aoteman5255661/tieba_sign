...
func getBDUSS() []string {
	...
	bdu := os.Getenv("BDUSS")
	//bdu := "DFhdlN6b1FQWWpMcVJjN2k5dUNJMlNTTGhGcDFSaGxGdjZnU2h1T1BKS21KMTVpRVFBQUFBJCQAAAAAAAAAAAEAAAA1LuUEYW90ZW1hbjUyNTU2NjEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKaaNmKmmjZiZ"
	bdussArr := []string{bdu}
